...
- `crates/sldr-renderer/layouts/*.html` - 44 layouts (default, cover, two-cols, hero-stat, timeline, versus, terminal, framed-*, framed-flow, etc.), each an HTML file with scoped CSS
